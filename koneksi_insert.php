<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    if ($admin !== NULL) {
      $insert = "INSERT INTO stock SET id_stock = NULL, created_date = '$date', season = '$season', product = '$product', color = '$color', status = '$status', qty = '$qty', created_by = '$admin', product_code = '$code'";
